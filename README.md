# Сайт Игоря Черницкого

Персональный сайт актера Игоря Черницкого, созданный с использованием React, Vite, TypeScript и TailwindCSS v4.

## 🎭 О проекте

Этот сайт представляет портфолио и биографию актера Игоря Черницкого, включающую информацию о его работах в театре и кино.
